    ...
    <body>
        ...
        if(isset($_POST['button'])){
            ...
            if(isset($Nom_comptable) && isset($Prenom_comptable) && $code_comptable);
                ...
                $req=mysqli_query($conn ," INSERT INTO comptable VALUES(NULL , '$Nom_comptable' , '$Prenom_comptable' , '$code_comptable')" );
                if($req){
        ...
        <div class="signup">
            ...
            <div class="signup-form">
                <form action="" , method="POST">
                    <label for="username">Nom_Comptable</label>
                    <input  name="Nom_comptable" placeholder="Entrez votre nom">
    
                    <label for="email">Prenom_Comptable</label>
                    <input  name="Prenom_comptable" placeholder="Entrez votre Prenom">
    
                    <label for="password">code_comptable</label>
